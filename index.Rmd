...
survey <- survey %>%
  dplyr::mutate(., barrier_lack_of_time = lack_time,
                barrier_organizing_data = org_data,
                barrier_which_repo = dont_know_repo,
                barrier_copyright_licensing = copyright,
                barrier_sharing_cost = costs)
```
